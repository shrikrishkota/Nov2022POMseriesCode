...
public class RegistrationPage {
	...
	public boolean registerUser(String firstName, String lastName, String email, String telephone, String password, String subscribe) {
		...
		String successMesg = eleUtil.waitForElementVisible(registerSuccessMesg, AppConstants.DEFAULT_LONG_TIME_OUT).getText();
		System.out.println("User registration success message is : " + successMesg);
		
		if(successMesg.contains(AppConstants.USER_REG_SUCCESS_MESG)) {
